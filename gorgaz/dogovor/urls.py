...
urlpatterns = [
    ...
    path('plansystem/', views.plan_system, name='plansystem'),
    ...
    path('printallorders/', views.order_printall, name='printallorders'),
    path('searchorder/', views.order_search, name='searchorder'),
